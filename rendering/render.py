...
def static_plot(static_plot_type):
    ...
    show_path = os.path.join(render_api.root_path,
                             'saved_plots/',
                             static_plot_type + '_show.svg')
    download_path = os.path.join(render_api.root_path,
                                 'saved_plots/',
...
@render_api.route("/static/<static_plot_type>/_plot_download")
def static_plot_download(static_plot_type):
    download_dir = os.path.join(render_api.root_path,
                            'saved_plots/')
    return flask.send_from_directory(directory=download_dir,
                                     filename=static_plot_type + '_download.eps')
