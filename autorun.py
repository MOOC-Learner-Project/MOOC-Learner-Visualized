...
def autorun():
    ...
    if not db_config_path:
        ...
        MLV_CONFIG_TEMPLATE['redis']['host'] = 'localhost'
        MLV_CONFIG_TEMPLATE['redis']['port'] = 6379
        MLV_CONFIG_TEMPLATE['redis']['db'] = 0
    else:
        ...
        MLV_CONFIG_TEMPLATE['redis']['host'] = db_cfg['redis']['host']
        MLV_CONFIG_TEMPLATE['redis']['port'] = db_cfg['redis']['port']
        MLV_CONFIG_TEMPLATE['redis']['db'] = db_cfg['redis']['db']
    ...
    # Check the redis server exists
    try:
        redis.StrictRedis(host=MLV_CONFIG_TEMPLATE['redis']['host'],
                          port=MLV_CONFIG_TEMPLATE['redis']['port'],
                          db=MLV_CONFIG_TEMPLATE['redis']['db'],)
    except redis.exceptions.ConnectionError:
        sys.exit('Redis server dose not exist')
